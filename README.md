...
1. Open the [latest VoicePrompt release](https://github.com/seNkoKG/VoicePrompt/releases/latest) and download `VoicePrompt-v1.2.1-windows-x64.zip`.
...
Verified end-to-end results (simulated): a clear English utterance landed **1.04 s** after key release; an ambiguous Slovenian utterance requiring the safety decode landed in **2.09 s**.
