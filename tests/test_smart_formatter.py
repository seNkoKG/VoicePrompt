...
class SmartFormatterTests(unittest.TestCase):
    ...
    def test_standalone_prose_finishes_sentence_but_code_does_not(self) -> None:
        self.assertEqual(
        ...
        self.assertEqual(
            format_dictation("this is a general message", DictationContext(app_kind="general")),
    ...
    def test_sentence_finishing_handles_short_text_quotes_and_existing_marks(self) -> None:
        self.assertEqual(format_dictation("send it"), "Send it.")
        self.assertEqual(format_dictation('he said "hello"'), 'He said "hello."')
        self.assertEqual(format_dictation("already done!"), "Already done!")
        self.assertEqual(format_dictation("search"), "Search")
